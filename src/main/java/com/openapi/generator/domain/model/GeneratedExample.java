...
/**
 * Represents a collection of generated example JSON strings for a schema.
...
public final class GeneratedExample {
    ...
    public GeneratedExample(String schemaName, List<String> exampleJsonStrings) {
        ...
        this.exampleJsonStrings = exampleJsonStrings != null ? List.copyOf(exampleJsonStrings) : List.of();
    }

    public String getSchemaName() { return schemaName; }
    public List<String> getExampleJsonStrings() { return exampleJsonStrings; }
    public int getCount() { return exampleJsonStrings.size(); }
}
